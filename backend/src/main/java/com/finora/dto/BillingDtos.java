...
public class BillingDtos {
    ...
    /** GET /api/v1/billing/history -- the user's own payment records (proposal §3.4), written by
     *  RazorpayWebhookDispatcher. Each row's own PDF is at
     *  GET /api/v1/billing/history/{id}/invoice, generated by InvoiceService. */
