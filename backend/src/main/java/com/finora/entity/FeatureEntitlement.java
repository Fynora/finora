...
public class FeatureEntitlement {
    ...
    // V163. Gmail sync is the one integration with real ongoing per-user cost (a scheduled worker
    ...
    // V218 also grants it to PLUS (owner decision 2026-09-21); see that migration.
