...
class UserAccountLifecycleServiceTest {
    ...
    void setUp() {
        ...
        service = new UserAccountLifecycleService(userRepository,
                ...
                refreshTokenService, auditService, emailProvider, requestMetadata, passwordChangeService,
    ...
    void deactivate_withTheCorrectPassword_setsStatusReasonAndRevokesEverySession() {
        ...
        service.deactivate(userId, "correct", null, null, "TAKING_A_BREAK", "Back in a bit");
    ...
    void deactivate_withABlankNote_storesNullNotEmptyString() {
        ...
        service.deactivate(userId, "correct", null, null, "OTHER", "   ");
    ...
    void deactivate_withAnUnrecognizedReason_isRejectedAndChangesNothing() {
        ...
        try {
            service.deactivate(userId, "correct", null, null, "NOT_A_REAL_REASON", null);
    ...
    void deactivate_onAGoogleAccount_verifiesAFreshGoogleTokenInsteadOfAPassword() {
        ...
        service.deactivate(userId, null, "fresh-google-token", null, "TAKING_A_BREAK", null);
    ...
    @Test
    void deactivate_onAnAppleAccount_verifiesAFreshAppleTokenInsteadOfAPassword() {
        User u = user(User.SCOPE_USER);
        u.setSignInMethod(User.SIGN_IN_METHOD_APPLE);
        when(userRepository.findById(userId)).thenReturn(Optional.of(u));
        when(appleIdTokenVerifierService.verify("fresh-apple-token"))
                .thenReturn(new com.finora.integrations.apple.login.AppleIdentity(u.getEmail(), "apple-subject"));

        service.deactivate(userId, null, null, "fresh-apple-token", "TAKING_A_BREAK", null);
    ...
    void deactivate_withTheWrongPassword_rejectsAndChangesNothing() {
        ...
        try {
            service.deactivate(userId, "wrong", null, null, "OTHER", null);
        } catch (ApiException e) {
    ...
    void deactivate_onAnAdminScopeAccount_isRejected() {
        ...
        try {
            service.deactivate(userId, "whatever", null, null, "OTHER", null);
        } catch (ApiException e) {
            assertThat(u.getStatus()).isEqualTo(User.STATUS_ACTIVE);
    ...
    void deactivate_onAPendingDeletionAccount_isRejectedBeforeCheckingThePassword() {
        ...
        try {
            service.deactivate(userId, "correct", null, null, "OTHER", null);
        } catch (ApiException e) {
