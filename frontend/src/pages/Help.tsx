...
const ARTICLES: HelpArticle[] = [
  ...
  { category: 'Billing & Subscriptions', question: 'What plans does Fynora offer?', answer: 'Two: Free and Plus (₹399/month or ₹3,500/year). Listed prices are GST-exclusive — 18% GST is added at checkout and itemized on your invoice.' },
