...
// ChangeEmailSheet's settings-based email change branches on this the same way -- the email
// belongs to a DIFFERENT account, and the fix is ending the CURRENT session so the one that
