...
// Phase 4 (Medium-Tier Parity). Port of frontend/src/lib/holderNameMatcher.test.ts, which itself
// mirrors backend/src/test/java/com/finora/imports/ownership/HolderNameMatcherTest.java -- same
// algorithm, same cases, kept in sync so a translation bug in the port shows up here.
